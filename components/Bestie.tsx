...
/**
 * The Halda Bestie — a parametric SVG creature that visibly grows through five
 * stages as the student completes weekly challenges. `stage` (0–4) drives size
 * and which features (arms, leaf antenna, sparkle aura, crown) are drawn.
 */
...
/** Map cumulative growth points to a stage index (0–4). */
...
export function Bestie({
  ...
  return (
    ...
    >
      ...
      <g
        className={petting ? "bestie-pet" : ""}
        style={{ transformOrigin: "100px 120px", transformBox: "view-box" as never }}
      >
        <g transform={`translate(100 118) scale(${scale}) translate(-100 -118)`}>
          ...
          {showLeaf && (
            <g>
              ...
              />
              <path
                d="M100 32 C112 22 126 26 124 40 C112 46 100 42 100 32 Z"
                fill="#4ade80"
              />
              <path
                d="M100 38 C90 30 78 33 80 44 C90 49 100 46 100 38 Z"
                fill="#22c55e"
              />
            </g>
          )}

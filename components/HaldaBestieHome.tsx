...
/** Tabs the home page can deep-link into (matches CommandCenter's TabId). */
type NavTab = "essay" | "activities" | "interview" | "deadlines" | "decisions";
...
const CHALLENGES: Challenge[] = [
  {
    id: "essay",
    title: "Glow up your essay",
    blurb: "Apply 1 counselor suggestion",
    icon: FileText,
    goal: 1,
    xp: 60,
    growth: 3,
  ...
  {
    id: "activity",
    title: "Flex an activity",
    blurb: "Add or polish 1 activity",
    icon: Award,
    goal: 1,
    xp: 40,
    growth: 2,
  ...
  },
  {
    ...
    blurb: "Answer 2 practice questions",
    icon: Mic,
    goal: 2,
    xp: 50,
    growth: 2,
  ...
  },
  {
    ...
    blurb: "Check 1 upcoming deadline",
    icon: CalendarClock,
    goal: 1,
    xp: 30,
    growth: 1,
...
const FRIENDS: Friend[] = [
  { name: "Maya", avatar: "🦊", streak: 34, level: 12, stage: 4, online: true, caption: "essay = DONE 😮‍💨", bg: "from-fuchsia-500 via-purple-600 to-pink-500", art: "📝" },
  { name: "Theo", avatar: "🐧", streak: 21, level: 9, stage: 3, online: true, caption: "interview prep grind", bg: "from-sky-500 via-blue-600 to-indigo-600", art: "🎤" },
  { name: "Priya", avatar: "🦋", streak: 12, level: 6, stage: 2, caption: "my bestie hit Lv6 🥹", bg: "from-rose-500 via-fuchsia-500 to-purple-600", art: "🦋" },
  { name: "Leo", avatar: "🐲", streak: 5, level: 4, stage: 1, caption: "submitted early action!!", bg: "from-emerald-500 via-teal-600 to-cyan-600", art: "🎉" },
];
...
export function HaldaBestieHome({ onNavigate }: { onNavigate?: (tab: NavTab) => void }) {
  ...
  function pet() {
    ...
    setHearts((h) => [...h, id]);
    setTimeout(() => setPetting(false), 460);
    ...
    <div className="relative mx-auto min-h-full w-full max-w-2xl px-4 pb-10 pt-4 sm:px-6">
      ...
      <section className="pop-in mt-4 overflow-hidden rounded-3xl border border-white/60 bg-gradient-to-br from-violet-500 via-purple-600 to-fuchsia-600 p-5 shadow-xl shadow-purple-500/20 dark:border-white/10">
        ...
        <div className="relative mt-1 flex justify-center">
          ...
          >
            <Bestie stage={stage} petting={petting} className="bestie-bob h-full w-full drop-shadow-2xl" />
            {/* pet hearts */}
            {hearts.map((id) => (
              <span
                key={id}
      ...
      <section className="mt-6">
        ...
        {/* dev/demo helper to advance tool-linked challenges without the tool */}
      </section>
